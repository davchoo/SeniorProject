        ...
        <div className="text-center md:text-left md:ml-10 md:mr-60 mb-10 md:mb-0 mt-20">
          ...
          <div className="mt-0">
            <Link to="/plan" className="hover:underline">
              <button className="bg-custom-green3 font-notosansjp font-bold border border-custom-green2 rounded-full px-6 py-2 md:px-8 md:py-3 hover:bg-custom-green hover:text-white transition duration-300 ease-in-out">
      ...
      <div className="bg-white py-15 mt-4 ml-4 mr-4">
        <div className="container mx-auto">
          ...
          <div className="flex flex-wrap justify-around">
            ...
            {/* Third */}
            <div className="w-full md:w-1/3 mb-8">
              <h3 className="text-xl font-notosansjp font-bold mb-4">Travel Assistance</h3>
          ...
          <div className="text-center font-notosansjp font-bold mt-4">
            <Link to="/about" className="hover:underline">
              <button className="w-full bg-custom-green3 font-notosansjp font-bold border border-custom-green2 px-6 py-2 md:px-8 md:py-3 hover:bg-custom-green hover:text-white transition duration-300 ease-in-out">
                Read More
              </button>
            </Link>
          </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="flex flex-wrap justify-around">
            ...
            <div className="w-full md:w-1/2 mb-8">
              ...
              <p className="font-notosansjp"> - Happy Traveler</p>
            </div>
            {/* Second Testimonial */}
            <div className="w-full md:w-1/2 mb-8">
              <blockquote className="italic mb-4">
              ...
              <p className="font-notosansjp"> - Satisfied Explorer</p>
            </div>
          </div>
        </div>
      </div>
