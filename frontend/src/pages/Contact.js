...
function Contact() {
  return (
    <div className="flex justify-center items-center h-full">
      <div className="max-w-screen-md mx-auto p-8 bg-custom-green m-5"> {/* Increased maximum width */}
        ...
        <div className="max-w-md w-full px-8 py-6 bg-white rounded-lg shadow-md">
          <p className="text-lg leading-relaxed text-gray-700"> {/* Changed text color */}
